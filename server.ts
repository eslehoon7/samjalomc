...
귀하의 건강 상태를 동양의학의 세 가지 근본 축인 **'잘자기(수면)', '잘먹기(식이)', '잘보내기(배변)'**의 관점으로 세심히 분석하고 정밀 분석 보고서를 제안해드립니다.
...
*   **잘보내기(변비 현상)**: 기체(氣滯)로 인해 장 전반의 연동력이 굳어 있으므로 하복부 침 치료와 고섬유 식단을 매칭해주시기 강경 권고합니다.`
  }
];
...
* **배변(잘보내기)**: 대장 점막의 수분 불균형이나 연동 저하로 잔변이 남는 기체(氣滯) 양상이므로 따뜻하게 한방 순환을 돕는 치료가 좋습니다.`;
