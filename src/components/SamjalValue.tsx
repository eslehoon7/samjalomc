...
export default function SamjalValue() {
  const values = [
    {
      title: "잘자기",
      desc: "잠은 단순한 휴식이 아닙니다. 항산화/항노화/재생의 원천입니다. 잘 자지 못하면 건강은 반드시 나빠지게 됩니다.",
    },
    {
      title: "잘먹기",
      desc: "먹는 것이 곧 내 몸이 됩니다. 좋은 음식을 잘 받아들일 수 있는 상태가 되어야 합니다.",
    },
    {
      title: "잘싸기",
      desc: "호흡, 대/소변, 땀을 통해 불필요한 노폐물을 원활히 배출할 수 있어야 합니다. 잘 내보내야 잘 채울 수 있습니다",
    },
  ];
